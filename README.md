...
User Stats:<br>
  ![User Draft Stats](/userCards/draft-1724022753988.svg?)

⚙️ Current Quest: 
  - Q1 - Exploring the GitHub World
    -  ~T1 - Explore the issue tracker~ [[COMPLETED](https://github.com/NAU-OSS/italo-07-test/issues/3)]
    - T2 - Explore the pull-request menu [[Click here to start](https://github.com/NAU-OSS/italo-07-test/issues/4)]
